...
{
    //Zobrane z netu a prisposobene projektu.... cryptuje subor pod zvolenym heslom
     ...
     **/
    public void encryptFile(String fileName, String pass) throws IOException, GeneralSecurityException
    {
        byte[] decData;
        byte[] encData;
    ...
    public void decryptFile(String fileName, String pass) throws GeneralSecurityException, IOException
    {
        byte[] encData;
        byte[] decData;
        File inFile = new File(fileName);
    ...
    //Debugovaci kod ktory nebol potrebny pri tomto projekte....
    /**Record the key to a text file for testing:
    private void keyToFile(SecretKey key)
    {
        try
        {
