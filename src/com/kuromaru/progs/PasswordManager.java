...
public class PasswordManager
{
    ...
    static void createFile() throws NoSuchAlgorithmException, IOException, ClassNotFoundException {
        ...
        if (Files.notExists(path))
        {
            ...
            {
                System.out.println("Error occured in createFile method...");
                e.printStackTrace();
            }
        }
    }
    ...
    static void confirmPassFrame() throws Exception
    {
        ...
        String valid = "Master DB created...";
    ...
    {
        loginPageWindow = new JFrame("PASS WALLET v2");
        ...
        //Poznamka: vycentrovat login label a gombiky... plus mensi font
        loginPageText.setFont(new java.awt.Font("Segoe UI", 0, 20)); //
        loginPageText.setText("Login");
        okBtn.setText("Ok");
    ...
    static void readDB() throws Exception
    {
        ...
        for (int i = 0; i < lines; i++)
        {
            ...
            String login;
            String pass;
            //Poznamka prerobit na viac riadkov jedno entry...
